...
abstract class $CountryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String code, String? capital});
}
...
class _$CountryImpl extends _Country {
  const _$CountryImpl({required this.name, required this.code, this.capital})
      : super._();
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, code, capital);
...
abstract class _Country extends Country {
  const factory _Country(
      ...
      final String? capital}) = _$CountryImpl;
